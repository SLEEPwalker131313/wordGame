...
import tryanko.test.com.wordgame.PartOfFieldDetail
import tryanko.test.com.wordgame.R
        ...
        verticalLayout {
            ...
            linearLayout {
                ...
                textView(player1name) {
                    ...
                    background = resources.getDrawable(R.mipmap.name_background1)
...
//                                        selectAll()
            ...
            linearLayout {
                ...
                imageView(resources.getDrawable(R.mipmap.list)) {
                    gravity = Gravity.CENTER
    ...
    /**
     * Установка преметров для содержимого TextView с никами игроков
     */
    private fun TextView.playerNameTextViewSettings() {
        textSize = 24F
        typeface = Typeface.createFromAsset(assets, "fonts/BadScript-Regular.ttf")
        gravity = Gravity.CENTER
    }
    ...
    /**
     * Установка отступов для корневого Layout
     */
    private fun _LinearLayout.mainLayoutPadding() {
        topPadding = 50
        leftPadding = 80
        rightPadding = 40
    }
    ...
    /**
     * Установка размеров поля в зависимости от выбранного варианта
     * @param fieldSize [Int] Размер поля
     */
    ...
    /**
     * Установка преметров для содержимого TextView с очками игроков
     */
